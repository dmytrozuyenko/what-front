        ...
        stage('deploy') {
          steps {
            withCredentials([sshUserPrivateKey(credentialsId: "aws-key", keyFileVariable: 'keyfile')]) {
              ...
              sh 'ssh -i ${keyfile} ubuntu@3.144.93.224 "          
//               sh 'echo -e "server {\nlisten 80;\nlisten [::]:80;\n\nroot /var/www/what-front;\nindex index.html index.htm index.js;\n\nlocation / {\ntry_files $uri /index.html;\n}\n}" > /home/ubuntu/what-front/nginx/what-front.conf'
//               sh 'docker run -it -p 8080:80 --name what-front -v /home/dmytrozuyenko/what-front/nginx/what-front.conf:/etc/nginx/conf.d/default.conf -v /home/dmytrozuyenko/what-front/dist/:/var/www/what-front/ nginx:latest"
            }
          }  
        }
